<?php
// Scenario: Demonstrates database connection, table creation, data insertion, query execution with dictionary results, and disconnection using SQLite
...
// Example 1: Connect to SQLite database and execute queries with dictionary results
...
if (!$tableExists) {
    ...
    echo("\n2. Create table execute query '$createTableQuery' : ");
...
echo("\n3. Insert first record. Query:  '$insertQuery1': ");
...
// Example 1.5: Select and display all records as dictionaries
$selectQuery = "SELECT * FROM $tableName ";
echo("\n5. Select and display all records as dictionaries: ");
$result = SYSTEM::$bd->query_dicts($connectionId, $selectQuery);
var_export($result);
