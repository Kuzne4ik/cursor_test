<?php
// Scenario: Check if a radio button is checked by its value
// Description: Demonstrates how to verify whether a radio button is checked using its value attribute
