...
/**
 * Пример использования функции get_rows_by_number класса XHETable
 * Example of using get_rows_by_number function of XHETable class
 * 
...
echo "=== Пример использования get_rows_by_number ===\n";
echo "=== Example of using get_rows_by_number ===\n\n";
...
$row_count = DOM::$table->get_rows_by_number(0); // Номер таблицы 0
...
$row_count_2nd = DOM::$table->get_rows_by_number(1); // Номер таблицы 1
...
$row_count_frame = DOM::$table->get_rows_by_number(0, "0"); // Таблица 0 во фрейме 0
...
$row_count_nested = DOM::$table->get_rows_by_number(0, "1:2:3"); // Таблица 0 во вложенных фреймах 1:2:3
...
echo "Все примеры get_rows_by_number завершены!\n";
echo "All get_rows_by_number examples completed!\n";
