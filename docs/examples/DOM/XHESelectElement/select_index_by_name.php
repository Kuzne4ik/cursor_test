<?php
// Scenario: Select an option by index in a select element found by its name
// Description: Demonstrates how to select an option by its index position from a select element based on its name attribute
