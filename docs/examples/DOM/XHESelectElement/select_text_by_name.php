...
$success = DOM::$listbox->select_text_by_name("country_select", "Canada");

if ($success) {
    echo "Successfully selected the option with text 'Canada' in the select element with name 'country_select'\n\n";
} else {
