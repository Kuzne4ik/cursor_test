...
$success = DOM::$listbox->select_value_by_attribute_by_form_number("id", "country_dropdown", true, "CA", true, 0);

if ($success) {
    echo "Successfully selected the option with value 'CA' in the select element with id 'country_dropdown' within form 0\n\n";
} else {
