...
// Сценарий: Для текущей страницы найти DOM элемент и получить все названия его атрибутов
// Описание: Для текущей страницы Браузера найти DOM элемент и получить его как XHEInterface, и получить все названия его атрибутов
...
// Пример 1: Получить объект anchor и получить все названия его атрибутов
