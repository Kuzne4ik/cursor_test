...
// Сценарий: Для текущей страницы найти DOM элемент и получить дочерний DOM элемент по значению внутреннего HTML
// Описание: Для текущей страницы найти 0 DOM элемент <form> и получить его дочерний DOM элемент по значению внутреннего HTML
...
// Пример 1: Для текущей страницы получить 0 DOM элемент <form> и получить его первый дочерний DOM элемент по значению внутреннего HTML, поиск на первом уровне дерева
