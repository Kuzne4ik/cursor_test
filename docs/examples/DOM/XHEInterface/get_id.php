...
// Описание: Для текущей страницы получить DOM элемент <anchor> по 'id' и получить его высоту
...
// Пример 1: Для текущей страницы получить DOM элемент <anchor> по 'id' и получить его высоту
