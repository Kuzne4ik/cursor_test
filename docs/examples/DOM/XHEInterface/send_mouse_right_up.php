...
// Scenario: Send mouse right up event to a DOM element
// Description: For current page, find a button element and send a mouse right up event to it
...
// Example 1: Send mouse right up event to a button element

// Navigate to Google
echo WEB::$browser->navigate("https://google.ru") . "\n";
...
if ($targetElement->inner_number != -1) {
    ...
    sleep(2);
    echo $targetElement->send_mouse_right_up(1, 1) . "\n";
}
