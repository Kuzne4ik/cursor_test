...
$res1 = $libreOfficeCalc->set_cell_color_by_position("test/test.ods", 0, "C2", "#e75322", "#22e74a");
$res1 = $res1 ? 'true' : 'false';
echo $res1."\n";

//2
echo "\n2. Установить шрифт оранжевый, фон синий для ячейки [5,1]: \n";
$res2 = $libreOfficeCalc->set_cell_color_by_position("test/test.ods", 0, "A5", "#e75322", "#227ee7");
