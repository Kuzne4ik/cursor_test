<?php
// Scenario: Demonstrates sending right mouse button down and up events to show context menu
...
$clickX = 100;
$clickY = 100;
$buttonDownResult = SYSTEM::$mouse->send_right_button_down($clickX, $clickY);
if ($buttonDownResult) {
...
$buttonUpResult = SYSTEM::$mouse->send_right_button_up($clickX, $clickY);
if ($buttonUpResult) {
