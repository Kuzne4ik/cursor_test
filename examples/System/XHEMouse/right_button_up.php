<?php
// Scenario: Demonstrates right mouse button up action to release context menu
...
// Example 1: Show application context menu at coordinates with pause before release
echo "1. Show application context menu at coordinates with pause before release: ";
$clickX = 100;
$clickY = 100;
