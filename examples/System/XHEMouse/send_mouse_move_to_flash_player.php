<?php
// Scenario: Demonstrates sending mouse move events to Flash player
...
// Navigate to test polygon page with Flash embed
echo "Navigate to test polygon page with Flash embed: ";
...
// Example 1: Send click to Flash player using browser coordinates (start video)
echo "1. Send click to Flash player using browser coordinates (start video): ";
$clickX = 300;
$clickY = 160;
$frameNumber = 0;
...
// Example 2: Get coordinates relative to Flash player
...
// Example 3: Send left mouse button click event using player coordinates
echo "3. Send left mouse button click event using player coordinates: ";
$playerX = 290;
$playerY = 150;
$frameNumber = 0;
...
// Example 4: Get coordinates relative to Flash player for current cursor position
