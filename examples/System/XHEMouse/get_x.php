<?php
// Scenario: Demonstrates how to get mouse X and Y coordinates in different contexts
...
// Example 1: Get current mouse X and Y coordinates on screen
echo("1. Get current mouse X and Y coordinates on screen\n");
$screenX = SYSTEM::$mouse->get_x();
$screenY = SYSTEM::$mouse->get_y();
echo("Mouse coordinates on screen: x=$screenX, y=$screenY\n");

// Example 2: Get current mouse X and Y coordinates in browser
echo("2. Get current mouse X and Y coordinates in browser\n");
