<?php 
// Scenario: Get the number of paragraphs in a Word document
...
// Example 1: Get the number of paragraphs in the document
echo("1. Get number of paragraphs in document: ");
