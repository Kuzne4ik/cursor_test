...
// Scenario: Demonstrate setting row values with type support
...
// Example 1: Set row 11 with type support
echo("\nExample 1: Set row 11 with type support in sheet $sheetNumber : ");
// Extract method arguments into variables
$rowNumber1 = 11;
$dataArray1 = array(1, 2.1, '14.08.2025', '001', true, true);
$asText1 = false;
$result = SYSTEM::$excelfile->set_row($excelFilePath, $sheetNumber, $rowNumber1, $dataArray1, $asText1);
if ($result === true)
    echo("true\n");
else
    echo("false\n");
...
// Example 3: Set row 12 with type support by dictionary
echo("\nExample 3: Set row 12 with type support by dictionary in sheet $sheetNumber : ");
// Extract method arguments into variables
$rowNumber2 = 12;
$dataArray2 = array(2, 2.1, '14.08.2026', '001', true, true);
$asText2 = false;
$result = SYSTEM::$excelfile->set_row($excelFilePath, $sheetNumber, $rowNumber2, $dataArray2, $asText2);
if ($result === true)
    echo("true\n");
else
    echo("false\n");
...
// Example 5: Set row 13, all cells as text, in sheet $sheetNumber
echo("\nExample 5: Set row 13, all cells as text, in sheet $sheetNumber : ");
// Extract method arguments into variables
$rowNumber3 = 13;
$asText3 = true;
$result = SYSTEM::$excelfile->set_row($excelFilePath, $sheetNumber, $rowNumber3, $dataArray1, $asText3);
if ($result === true)
    echo("true\n");
else
    echo("false\n");
