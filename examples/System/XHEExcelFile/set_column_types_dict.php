...
// Example 1: Add column types dictionary
echo("\nExample 1: Add column types dictionary for sheet $sheetNumber : ");
// Extract method arguments into variables
...
$columnsTypesArray[11] = "Number";
$columnsTypesArray[12] = "Number";
$columnsTypesArray[13] = "DateTime";
...
// Example 2: Set sheet content from array with type support by dictionary
echo("\nExample 2: Set sheet content from array start cell 10:10 with type support by dictionary in sheet $sheetNumber : ");
// Extract method arguments into variables
$sheetArray = array(
...
// Example 3: Remove column types dictionary
echo("\nExample 3: Remove column types dictionary for sheet $sheetNumber : ");
// Extract method arguments into variables
$result = SYSTEM::$excelfile->remove_column_types_dict($excelFilePath, $sheetNumber);
if ($result === true)
    echo("true\n");
