...
// Scenario: Demonstrate adding multiple rows with different data types and column type dictionaries
...
// Data array for adding
$dataArr = array(
    array(1, 2.1, '14.08.2025', '001', true),
    array(2, 2.2, '14.09.2025', '001', true),
	array(3, 2.3, '14.10.2025', '001', false),
    array(4, 2.4, '14.11.2025', '001', false),
);
...
// Header row
$jsonHeaderRow = array("Data with typing obtained from JSON serialization");
SYSTEM::$excelfile->add_row($excelFilePath, $sheetNumber, $jsonHeaderRow);

// Example 1: Add rows with JSON typing
// For JSON, date cell will get date value as date if string is date in ISO 8601 format. Example: '2012-04-21T18:25:43-03:00'
echo("\nExample 1: Add rows with typing to sheet $sheetNumber: ");
// Extract method arguments into variables
$startRow1 = 3000;
$asStrings1 = false;
echo(SYSTEM::$excelfile->add_rows($excelFilePath, $sheetNumber, $dataArr, $startRow1, $asStrings1));
...
echo("\n" . SYSTEM::$excelfile->set_column_types_dict($excelFilePath, $sheetNumber, $columns_types_array));
...
// Example 3: Add rows with typing by dictionary
echo("\nExample 3: Add rows with typing by dictionary to sheet $sheetNumber");
// Extract method arguments into variables
$startRow3 = 3;
$asStrings3 = false;
echo(SYSTEM::$excelfile->add_rows($excelFilePath, $sheetNumber, $dataArr, $startRow3, $asStrings3));
...
// Example 5: Add rows with all cells as strings
echo("\nExample 5: Add new rows, all cells are strings, to sheet $sheetNumber: ");
// Extract method arguments into variables
$startRow5 = 3;
$asStrings5 = true;
echo(SYSTEM::$excelfile->add_rows($excelFilePath, $sheetNumber, $dataArr, $startRow5, $asStrings5));
