...
// Scenario: For the current page, find a DOM element and get all names of its attributes
// Description: For the current Browser page, find a DOM element and get it as XHEInterface, and get all names of its attributes
...
// Example 1: Get the anchor object and get all names of its attributes
