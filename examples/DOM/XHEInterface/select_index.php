...
// Scenario: Select an option by index in a listbox element
// Description: For current page, find a listbox element and select an option by index
...
// Example 1: Select an option by index in a listbox element
...
if ($targetListbox->inner_number != -1) {
    // Select option by index 3
    echo $targetListbox->select_index(3);
}
