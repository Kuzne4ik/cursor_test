...
// Scenario: Perform mouse right down and up events on a DOM element
// Description: For current page, find a DOM element and perform mouse right down and up events on it
