...
// Scenario: For current page, find a DOM element and get its outer HTML
// Description: For current page, find a DOM element and get its outer HTML
...
// Example 1: Get outer HTML of element with number 2
