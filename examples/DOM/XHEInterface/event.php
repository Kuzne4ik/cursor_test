...
// Scenario: For the current page, find a DOM element and send a JS event to it
// Description: For the current Browser page, find a DOM element <a> and get it as XHEInterface, and send a JS event to it
...
// Example 1: Get the anchor object and send a JS event "onclick" to it
...
{
    // For the found anchor object, send a JS event "onclick"
