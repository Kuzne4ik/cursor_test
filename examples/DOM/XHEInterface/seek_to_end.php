...
// Scenario: Move cursor to the end of a textarea element
// Description: For current page, find a textarea element and move cursor to its end
...
// Example 1: Move cursor to the end of a textarea element
...
if ($targetTextarea->inner_number != -1) {
    // Move cursor to the very end of textarea
    echo $targetTextarea->seek_to_end();
}
