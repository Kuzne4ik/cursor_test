...
$col_count = DOM::$table->get_cols_count_by_number(0); // Table number 0
...
$col_count_2nd = DOM::$table->get_cols_count_by_number(1); // Table number 1
...
$col_count_frame = DOM::$table->get_cols_count_by_number(0, "0"); // Table 0 in frame 0
...
$col_count_nested = DOM::$table->get_cols_count_by_number(0, "1:2:3"); // Table 0 in nested frames 1:2:3
