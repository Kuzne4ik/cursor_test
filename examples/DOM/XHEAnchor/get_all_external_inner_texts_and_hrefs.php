<?php
// Scenario: Get all external links and their texts from a webpage
// Description: Demonstrates how to retrieve all external anchor links and their inner texts from a webpage
