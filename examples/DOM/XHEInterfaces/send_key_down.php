...
// Scenario: Send key down events to elements in a collection using JavaScript events
// Description: This example demonstrates how to get a collection of input elements and send key down events to each element using JavaScript
...
// Example: Get all input elements and send key down events to each element using JavaScript
...
if ($inputs->count() > 0)
{
    ...
    $updatedValues = $inputs->get_value();
    
    echo "\nUpdated values after first key press:\n";
