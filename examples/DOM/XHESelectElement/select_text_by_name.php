<?php
// Scenario: Select an option by text content in a select element found by its name
// Description: Demonstrates how to select an option by its text content from a select element based on its name attribute
