<?php
// Scenario: Demonstrates how to select multiple options by texts in a select element found by number
...
// Select multiple options by texts in a multi-select element found by number
// Parameters:
