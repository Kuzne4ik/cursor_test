<?php
// Scenario: Check if a checkbox is checked by its number
// Description: Demonstrates how to determine if a checkbox is checked based on its numerical order on the page
