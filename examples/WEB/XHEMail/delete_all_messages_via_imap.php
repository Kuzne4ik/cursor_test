<?php
// Scenario: Delete all messages from IMAP folder using IMAP protocol
...
try {
    ...
    if ($isConnected) {
        ...
        // Example 1
        echo("\n\nExample 1. Delete all messages in folder '$targetFolder': ");
        echo(WEB::$mail->delete_all_messages_via_imap($targetFolder));
