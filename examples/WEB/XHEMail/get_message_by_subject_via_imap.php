<?php
// Scenario: Demonstrates getting messages by subject via IMAP
...
try {
    ...
    if ($isConnected) {
        ...
        echo("\nExample 1: Get message by subject '$subjectSearch' in folder '$targetFolder': ");
        $message = WEB::$mail->get_message_by_subject_via_imap($targetFolder, $subjectSearch, false, 0);
