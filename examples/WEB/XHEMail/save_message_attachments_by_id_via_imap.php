<?php
// Scenario: Demonstrates saving message attachments by ID via IMAP
...
try {
    ...
    if ($isConnected) {
        ...
        // Example 1: Save attachments by ID
        echo("\nExample 1: Save attachments of message by ID = $message->message_id in folder '$targetFolder': ");
        var_export(WEB::$mail->save_message_attachments_by_id_via_imap("test", $targetFolder, $message->message_id));
