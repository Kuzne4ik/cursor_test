<?php
// Scenario: Get message by number using POP3 protocol
...
// Step 3
echo "Step 3. Get from field of message 0: ";
$message = WEB::$mail->get_message_by_number_via_pop3(0);
echo $message->from."\n";

// Step 4
echo "Step 4. Get subject of message 0: ";
echo $message->subject."\n";

// Step 5
echo "Step 5. Get date of message 0: ";
echo $message->date."\n";

// Step 6
echo "Step 6. Get body of message 0: ";
echo strlen($message->body)."\n";

// Step 7
echo "Step 7. Get text body length of message 0: ";
echo strlen($message->text_body)."\n";
...
// Step 9
echo "Step 9. Get number of messages: ";
echo WEB::$mail->get_message_count_via_pop3()."\n";
...
// Step 10
echo "Step 10. Get number of messages: ";
echo WEB::$mail->get_message_count_via_pop3()."\n";
