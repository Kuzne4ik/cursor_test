<?php
// Scenario: Save message attachments by from field using IMAP protocol
...
try {
    ...
    if ($isConnected) {
        ...
        // Example 1
        echo("\n\nExample 1. Save attachments of message 0 in folder 'test'. Find message by from address = $imapLogin: ");
        $saveFolder = "test";
        var_export(WEB::$mail->save_message_attachments_by_from_via_imap($saveFolder, $targetFolder, $imapLogin));
