<?php
// Scenario: Demonstrates moving messages by ID via IMAP
...
try {
    ...
    if ($isConnected) {
        ...
        // Example 1: Move message by ID
        echo("\nExample 1: Move message by ID = $message->message_id from folder '$targetFolder': ");
        echo(WEB::$mail->move_message_by_id_via_imap($targetFolder, "test2", $message->message_id));
