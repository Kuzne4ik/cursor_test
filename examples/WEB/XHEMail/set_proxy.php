<?php
// Scenario: Set proxy for mail operations
...
// Step 3
echo "Step 3. Delete message 0 containing @corp.mail.ru in from field: ";
//echo WEB::$mail->delete_message_by_from_via_pop3("@corp.mail.ru")."\n";
...
// Step 6 - Without proxy
$proxyUrl = "";
WEB::$mail->set_proxy($proxyUrl);

// Step 7
echo "Step 7. Connect to POP3 mail.ru: ";
$pop3Server = "pop.mail.ru";
$pop3Port = 995;
$username = "leyla.zubkova";
$password = "ddluzbcc";
echo WEB::$mail->pop3_connect($pop3Server, $pop3Port, $username, $password)."\n";
...
// Step 9
echo "Step 9. Disconnect from POP3: ";
echo WEB::$mail->pop3_disconnect()."\n";
