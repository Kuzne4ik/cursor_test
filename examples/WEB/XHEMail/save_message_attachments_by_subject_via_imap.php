<?php
// Scenario: Demonstrates saving message attachments by subject via IMAP
...
try {
    ...
    if ($isConnected) {
        ...
        // Example 1: Save attachments by subject
        echo("\nExample 1: Save attachments of message by subject '$subjectSearch' in folder '$targetFolder': ");
        var_export(WEB::$mail->save_message_attachments_by_subject_via_imap("test", $targetFolder, $subjectSearch));
