<?php
// Scenario: Demonstrates getting messages by from field via IMAP
...
try {
    ...
    if ($isConnected) {
        ...
        echo("\nExample 1: Get message by from field in folder '$targetFolder' with from = '$fromSearch': ");
        $message = WEB::$mail->get_message_by_from_via_imap($targetFolder, $fromSearch);
