<?php
// Scenario: Send mail using SMTP protocol
...
// Example 1
echo "Example 1. Send message via Rambler: ";
...
// Example 2
echo "Example 2. Send message via Yahoo: ";
...
// Example 3
echo "Example 3. Send message via Yandex: ";
...
// Example 4
echo "Example 4. Send message via Mail: ";
...
// Step 1
echo "Step 1. Disconnect from SMTP: ";
