<?php
// Scenario: Demonstrates getting messages by ID via IMAP
...
try{
    ...
    if ($isConnected) {
        ...
        echo("Example 1: Get message by ID = '$message->message_id' in folder '$targetFolder': ");
        $message = WEB::$mail->get_message_by_id_via_imap($targetFolder, $message->message_id);
        ...
        echo("Step 6: Get message count in folder '$targetFolder': ");
