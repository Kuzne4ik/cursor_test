<?php
// Scenario: Demonstrates moving messages by subject via IMAP
...
try {
    ...
    if ($isConnected) {
        ...
        // Example 1: Move message by subject
        echo("\nExample 1: Move message with subject '$message->subject' from folder '$targetFolder': ");
        echo(WEB::$mail->move_message_by_subject_via_imap($targetFolder, "test2", $message->subject));
