<?php
// Scenario: Get message by sender address
...
try{
    ...
    if ($isConnected) {
        // Example 1: Get message by sender address, unread
        echo("\nExample 1: Get message by sender address, unread: ");
        ...
        $dateFrom = "";
        $dateTo = "";
        print_r(WEB::$msexchange->get_message_by_from($folderName, $fromAddress, $exactMatch, $messageIndex, $isRead, $dateFrom, $dateTo));

        // Example 2: Get message by sender address, unread by date
        echo("\nExample 2: Get message by sender address, unread by date: ");
        $dateFrom = "09.06.2025";
        $dateTo = "09.06.2025";
        print_r(WEB::$msexchange->get_message_by_from($folderName, $fromAddress, $exactMatch, $messageIndex, $isRead, $dateFrom, $dateTo));
