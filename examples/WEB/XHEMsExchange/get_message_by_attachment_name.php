<?php
// Scenario: Get message by attachment name
...
try{
    ...
    if ($isConnected) {
        // Example 1: Get 0th message by partial attachment file name
        echo("\nExample 1: Get 0th message by partial attachment file name: ");
        $folderName = "TEST_TEST";
        $attachmentPartialName = "СКАН";
        print_r(WEB::$msexchange->get_message_by_attachment_name($folderName, $attachmentPartialName));

        // Example 2: Get 1st message by partial attachment file name
        echo("\nExample 2: Get 1st message by partial attachment file name: ");
        $messageIndex = 1;
        print_r(WEB::$msexchange->get_message_by_attachment_name($folderName, $attachmentPartialName, false, $messageIndex));
