<?php
// Scenario: Delete all messages from a folder
...
try{
    ...
    if ($isConnected) {
        ...
        echo("Step 2: Get message count in the specified folder: ");
        $folderName = "TEST_DOLENKO_DELETE";
        echo(WEB::$msexchange->get_message_count($folderName));

        // Example 1: Delete all messages
        echo("\nExample 1: Delete all messages: ");
        var_export(WEB::$msexchange->delete_all_messages($folderName));

        // Step 3: Get message count after deletion
        echo("\nStep 3: Get message count in the specified folder after deletion: ");
        echo(WEB::$msexchange->get_message_count($folderName));
    }
}
finally
