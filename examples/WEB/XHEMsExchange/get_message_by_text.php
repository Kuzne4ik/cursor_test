<?php
// Scenario: Get message by text content
...
try{
    ...
    if ($isConnected)
    {
        // Example 1: Get message with specified text
        echo("\nExample 1: Get message with specified text: ");
        $folderName = "TEST_DOLENKO";
        $searchText = "test";
        $exactMatch = false;
        print_r(WEB::$msexchange->get_message_by_text($folderName, $searchText, $exactMatch));

        // Example 2: Get message with specified text in folder by date
        echo("\nExample 2: Get message with specified text in folder by date: ");
        $messageIndex = 0;
        $isRead = false;
        $dateFrom = "09.06.2025";
        $dateTo = "09.06.2025";
        print_r(WEB::$msexchange->get_message_by_text($folderName, $searchText, $exactMatch, $messageIndex, $isRead, $dateFrom, $dateTo));
