<?php
// Scenario: Demonstrates how to get detailed information about a UI element
...
// Example 1: Get detailed information about the UI element
...
if ($elementInfo) {
    ...
    echo("Element ID: " . $elementInfo->AutomationId . "\n");
    echo("Element Class: " . $elementInfo->ClassName . "\n");
    echo("Element IsEnabled: " . ($elementInfo->IsEnabled ? "True" : "False") . "\n");
    echo("Element IsVisible: " . ($elementInfo->IsVisible ? "True" : "False") . "\n");
} else {
