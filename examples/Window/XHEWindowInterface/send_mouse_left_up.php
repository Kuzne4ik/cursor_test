...
// Scenario: Select text in the editor using send_mouse_left_up and send_mouse_left_down

// Step: Get the browser window interface
$windowText = "localhost";
$browserWindow = WINDOW::$window->get_by_text($windowText);

// Example 1: Select text in the editor using send_mouse_left_up and send_mouse_left_down
echo "Example 1: Select text in the editor using send_mouse_left_up and send_mouse_left_down\n";
