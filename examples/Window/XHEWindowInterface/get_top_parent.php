...
// Scenario: Get coordinates of a child window and text of its top parent window
echo "\n";
...
// Example 2: Get text of the top parent window for the Left Pane
echo "Example 2: Get text of the top parent window for the Left Pane\n";
$topParentWindow = $leftPane->get_top_parent();
$topParentWindowText = $topParentWindow->get_text();
echo "Text of the top parent window: " . $topParentWindowText . "\n";
