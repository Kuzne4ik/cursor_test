...
if ($debugWindows->count() > 0) {
    ...
    if ($isMoved) {
        ...
        // Example mouse_right_down: Press the right mouse button at the debug panel
        echo "Example mouse_right_down: Press right mouse button: ";
        ...
        if ($isRightDown) {
            ...
            if ($isRightUp) {
                ...
                // step 5: Wait a moment to see the context menu
                sleep(1);
                echo "Context menu displayed for 1 second.\n";
                
                // step 6: Hide the context menu by pressing ESC key
